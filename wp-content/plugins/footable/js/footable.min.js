...
(function (e, t) {
	...
	function o(o, i, n) {
			...
			if (l.addRowToggle) {
				...
				for (var o in r.columns) {
					...
					if (i.toggle) {
						...
						return t.find(n).not("." + d.detailCell).prepend(e("<span />").addClass(d.toggle)),
						undefined
					}
				}
		...
		r.getColumnData = function (t) {
			...
			i = a.index();
			o = o || "",
			o = jQuery.map(o.split(","), function (e) {
		...
		r.calculateWidth = function (e, t) {
			...
			return jQuery.isFunction(l.calculateWidthOverride) ? l.calculateWidthOverride(e, t) : (t.viewportWidth < t.width && (t.width = t.viewportWidth),  t)
		},
		...
		r.resize = function () {
			...
			if (t.is(":visible") && r.hasAnyBreakpointColumn()) {
				...
				console.log('before :'+a.width);
				a = r.calculateWidth(t, a);
				console.log('after : '+a.width);
		...
		r.redraw = function () {
			...
			t.find("> thead > tr, > tbody > tr").find("> th:visible:last, > td:visible:last").addClass("footable-last-column").end().find("> th:visible:first, > td:visible:first").addClass("footable-first-column"),
			r.raise(s.redrawn)
		},
